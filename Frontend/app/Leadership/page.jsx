...
export default function Leadership() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-gray-100 py-28">
      <h1 className="text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-6">
        Meet Our Leaders
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-10 max-w-7xl mx-auto">
        {founders.map((founder) => (
          <div
            key={founder.id}
            className="w-full h-[480px] perspective cursor-pointer"
          ...
          >
            <div className={`flip-card-inner ${activeCard === founder.id ? "flipped" : ""}`}>
              ...
              <div className="flip-card-back bg-gradient-to-tr from-blue-500 to-purple-600 text-white rounded-2xl shadow-lg flex items-center justify-center">
                <p className="text-xl font-semibold px-4">Click to Reveal</p>
              </div>
              ...
              <div className="flip-card-front bg-white rounded-2xl shadow-xl hover:shadow-2xl transition duration-500">
                ...
                <div className="p-6 text-center">
                  <h2 className="text-xl font-bold text-gray-800 mb-1">{founder.name}</h2>
                  <p className="text-blue-600 font-medium mb-3">{founder.role}</p>
                  <p className="text-gray-600 text-sm mb-5 leading-relaxed">{founder.desc}</p>
  ...
  <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-700 via-purple-700 to-pink-600 bg-clip-text text-transparent mb-8 animate-fadeIn">
    Our Leadership Vision
  </h2>

  <p className="text-gray-800 text-lg md:text-xl leading-relaxed tracking-wide font-[Playfair Display] italic transition duration-500 hover:scale-[1.02]">
